...
public static class WmscCapabilitiesParser
{
    public static async Task<IEnumerable<HttpTileSource>> Parse(Uri uri)
    {
    ...
    public static IEnumerable<HttpTileSource> Parse(XDocument document)
    {
