...
namespace BruTile.Web
{
    internal class HttpTileSourceSurrogate : ISerializationSurrogate
    {
        ...
        public void GetObjectData(object obj, SerializationInfo info, StreamingContext context)
        {
            ...
            //Provider
            var p = Utility.GetFieldValue<WebTileProvider>(ts, "_provider");
            info.AddValue("provider", p, typeof(WebTileProvider));
        }
        ...
        public object SetObjectData(object obj, SerializationInfo info, StreamingContext context, ISurrogateSelector selector)
        {
            ...
            //Provider
            Utility.SetFieldValue(ref obj, "_provider", newValue: info.GetValue("provider", typeof(WebTileProvider)));
